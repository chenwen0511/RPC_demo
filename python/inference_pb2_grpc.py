...
class TensorRTEngineStub(object):
    """定义服务 - 相当于 HTTP 的接口
    """
...
class TensorRTEngineServicer(object):
    """定义服务 - 相当于 HTTP 的接口
    """
...
def add_TensorRTEngineServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'ai_service.TensorRTEngine', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ai_service.TensorRTEngine', rpc_method_handlers)
